...
<body>
 ...
 <div class="row  topnav">
        ...
        <div class="row px-xl-5">
            <div class="col-12" style="direction: rtl;">
                <nav class="breadcrumb bg-light mb-30">
                    <a class="breadcrumb-item text-dark text-decoration-none" href="#">کور پاڼه</a>
                   <span class="breadcrumb-item active"></span>
                    <span class="breadcrumb-item active">جزیات</span>
                </nav>
            </div>
        </div>
    </div>
    <!-- Breadcrumb End -->
     ...
     <!-- Shop Detail Start------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ -->
    <div class="container-fluid pb-5" style="direction:rtl">
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="img/butery2.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="img/butter3.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="img/butery6.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="img/sumersible.jpg" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    <h3 style="text-align:right;">د محصول نوم</h3>
                    <div class="d-flex mb-3">
                      ...
                      <!--   <small class="pt-1">(99 کتل شوی)</small> -->
                    </div>
                    <h3 style="text-align: right;" class="font-weight-semi-bold mb-4">اف150.00</h3>
                    <p style="text-align: right;" class="mb-4">د محصول په اړه معلدمات</p>
                    <div class="d-flex mb-3">
                        <strong class="text-dark mr-3">سایز:</strong>
                        
                    </div>
                    <div class="d-flex mb-4">
                        <strong class="text-dark mr-3">رنګ:</strong>
                       
                    </div>
                  
                    <div class="d-flex pt-2">
                        <strong class="text-dark mr-2">شریک یی کړی:</strong>
            ...
            <div class="col">
                <div class="bg-light p-30">
                    <div class="nav nav-tabs mb-4">
                        <a class="nav-item nav-link text-dark active" data-toggle="tab" href="#tab-pane-1">جریات</a>
                      
                        <a class="nav-item nav-link text-dark" data-toggle="tab" href="#tab-pane-3">نظر.نه(0)</a>
                    </div>
                    <div class="tab-content" style="direction:rtl;">
                        <div class="tab-pane fade show active" id="tab-pane-1" style="text-align:right;">
                            <h4 class="mb-3">د محصول په اړه معلومات</h4>
                            <p>د محصول په اړه معلومات د محصول په اړه معلومات د محصول په اړه معلومات د محصول په اړه معلومات د محصول په اړه معلومات د محصول په اړه معلومات د محصول په اړه معلومات د محصول په اړه معلومات.</p>
                            <p>د محصول په اړه معلومات.</p>
                        </div>
                      
                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row">
                                  <div class="col-md-6" style="text-align: right;">
                                    <h4 class="mb-4">نظر مو پریږدی</h4>
                                    <small>ستاسو ایمل ادرس به نه شریک کیږی. په نښه شوی فیلډونه ضروری دی *</small>
                                    <div class="d-flex my-3">
                                      
                                    </div>
                                      <form>
                                        <div class="form-group">
                                            <label for="message">نطر*</label>
                                        ...
                                        <div class="form-group mb-0">
                                            <input type="submit" value="شریک یی کری" class="btn btn-primary px-3">
                                        </div>
                                    </form>
                                </div>
                                <div class="col-md-6">
                                    <h4 class="mb-4">1 د مشتریانو نطرونه د مخصول په اړه"</h4>
                                    <div class="media mb-4">
                                        <img src="img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                        <div class="media-body">
                                            <h6>نوم<small> - <i>تاریخ</i></small></h6>
                                          
                                            <p>دا بظری ما اخستې وه یوه افغانی هم ارزښت نه لری.</p>
                                        </div>
                                    </div>
                                </div>
