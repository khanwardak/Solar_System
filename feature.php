...
<body>
   ...
   <?php include('header.php') ?>
    ...
    <div class="container-fluid bg-light overflow-hidden my-5 px-lg-0" style="direction:rtl">
        <div class="container feature px-lg-0" style="direction:rtl">
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                    <div class="p-lg-5 ps-lg-0">
                        <h6 class="text-primary">ولې سولر تیک عوره کړو</h6>
                        <h1 class="mb-4">ښه با کیفته او باوری خدمات</h1>
                        <p class="mb-4 pb-2">سولر په ټول افغانستان کې لومړنی شرکت دی چې ښه او باوری خدمات وړاندې کوی، چې تقریبا ټول مشتریان ور څخه راضی دی</p>
                        <div class="row g-4">
                            <div class="col-6">
